...
break;
    ...
    case 'ssvTabHeaderLan':
        ...
        //2.构建表格内容
        /** 返回数据格式
            "LAN":{ "accessList":[{"MAC":"xx", "IP":"xx", "type":"xx"},{..}]}
        ** html 格式
...
CSysStatusView.prototype.loadHtml = function(){
    ...
    var enHtmlMap = {ssvTitleIntCfgTxt:"Internet Configuration",ssvTitleNetStatTxt:"Networking Status",ssvTypeTxt:"Module Type",ssvConnectStatTxt:"Connection Status",
            ...
            ssvtlanInforTitle:"LAN Information",ssvTabDHCPCfg:"DHCP cfg",ssvTabLanDevLst:"Accessed List",ssvTabLanDevMac:'Device MAC',ssvTabLanDevIP:'Device IP',ssvTabLanDevType:"Device Type", 
    ...
    var cnHtmlMap = {ssvTitleIntCfgTxt:"Internet 配置状态",ssvTitleNetStatTxt:"网络状态",ssvTypeTxt:"联机型态",ssvConnectStatTxt:"连接状态",
            ...
            ssvtlanInforTitle:"LAN 信息",ssvTabDHCPCfg:"DHCP配置",ssvTabLanDevLst:"设备接入列表",ssvTabLanDevMac:'设备MAC',ssvTabLanDevIP:'设备IP',ssvTabLanDevType:"设备类型", 
