...
class MockNetworkHandler(Handler, BaseMockHandler):
    ...
    def get_settings(self, data):
        ...
        """
        result = {
            "forwarding_enabled": MockNetworkHandler.forwarding_enabled,
            "dnssec_enabled": MockNetworkHandler.dnssec_enabled,
            "dns_from_dhcp_enabled": MockNetworkHandler.dns_from_dhcp_enabled,
        }
        if MockNetworkHandler.dns_from_dhcp_domain:
            result["dns_from_dhcp_domain"] = MockNetworkHandler.dns_from_dhcp_domain
        return result
    ...
    def update_settings(
        ...
        :rtype: bool
        """
        MockNetworkHandler.forwarding_enabled = forwarding_enabled
        MockNetworkHandler.dnssec_enabled = dnssec_enabled
        MockNetworkHandler.dns_from_dhcp_enabled = dns_from_dhcp_enabled
