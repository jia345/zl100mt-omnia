...
from foris_controller_backends.network import NetworkUciCommands
...
class OpenwrtNetworkHandler(Handler, BaseOpenwrtHandler):
    uci_network_cmds = NetworkUciCommands()
    ...
    def get_settings(self, data):
        ...
        :rtype: dict
        """
        return OpenwrtNetworkHandler.uci_network_cmds.get_settings(data)
    ...
    def update_settings(self, data):
        ...
        :rtype: str
        """
        return OpenwrtNetworkHandler.uci_network_cmds.update_settings(data)
