...
from foris_controller_backends.channelmap import ChannelmapUciCommands
...
class OpenwrtChannelmapHandler(Handler, BaseOpenwrtHandler):
    uci_channel_cmds = ChannelmapUciCommands()
    ...
    def get_settings(self, data):
        ...
        :rtype: dict
        """
        return OpenwrtChannelmapHandler.uci_channel_cmds.get_settings(data)
    ...
    def update_settings(self, data):
        ...
        :rtype: str
        """
        return OpenwrtChannelmapHandler.uci_channel_cmds.update_settings(data)
