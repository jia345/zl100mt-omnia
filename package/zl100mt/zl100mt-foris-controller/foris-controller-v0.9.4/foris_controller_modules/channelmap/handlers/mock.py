...
class MockChannelmapHandler(Handler, BaseMockHandler):
    ...
    def get_settings(self,data):
        ...
        """
        result = {
            "forwarding_enabled": MockChannelmapHandler.forwarding_enabled,
            "dnssec_enabled": MockChannelmapHandler.dnssec_enabled,
            "dns_from_dhcp_enabled": MockChannelmapHandler.dns_from_dhcp_enabled,
        }
        if MockChannelmapHandler.dns_from_dhcp_domain:
            result["dns_from_dhcp_domain"] = MockChannelmapHandler.dns_from_dhcp_domain
        return result
    ...
    def update_settings(
        ...
        :rtype: bool
        """
        MockChannelmapHandler.forwarding_enabled = forwarding_enabled
        MockChannelmapHandler.dnssec_enabled = dnssec_enabled
        MockChannelmapHandler.dns_from_dhcp_enabled = dns_from_dhcp_enabled
