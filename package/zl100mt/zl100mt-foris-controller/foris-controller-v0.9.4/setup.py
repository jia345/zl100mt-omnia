...
setup(
    ...
    packages=[
        ...
        'foris_controller_backends.channelmap',
        'foris_controller_backends.dhcp',
        'foris_controller_backends.diagnostics',
        'foris_controller_backends.ipmacbind',
        'foris_controller_backends.network',
        'foris_controller_backends.redirect',
        'foris_controller_backends.rtmp',
        'foris_controller_backends.proto_forward',
        'foris_controller_backends.storage',
        'foris_controller_backends.firewall',
        ...
        'foris_controller_modules.channelmap',
        'foris_controller_modules.channelmap.handlers',
        'foris_controller_modules.dhcp',
        'foris_controller_modules.dhcp.handlers',
        'foris_controller_modules.diagnostics',
        'foris_controller_modules.diagnostics.handlers',
        'foris_controller_modules.ipmacbind',
        'foris_controller_modules.ipmacbind.handlers',
        'foris_controller_modules.network',
        'foris_controller_modules.network.handlers',
        'foris_controller_modules.redirect',
        'foris_controller_modules.redirect.handlers',
        'foris_controller_modules.rtmp',
        'foris_controller_modules.rtmp.handlers',
        'foris_controller_modules.proto_forward',
        'foris_controller_modules.proto_forward.handlers',
    ...
    package_data={
        ...
        'foris_controller_modules.channelmap': ['schema', 'schema/*.json'],
        'foris_controller_modules.dhcp': ['schema', 'schema/*.json'],
        'foris_controller_modules.diagnostics': ['schema', 'schema/*.json'],
        'foris_controller_modules.ipmacbind': ['schema', 'schema/*.json'],
        'foris_controller_modules.network': ['schema', 'schema/*.json'],
        'foris_controller_modules.redirect': ['schema', 'schema/*.json'],
        'foris_controller_modules.rtmp': ['schema', 'schema/*.json'],
        'foris_controller_modules.proto_forward': ['schema', 'schema/*.json'],
