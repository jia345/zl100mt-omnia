...
class MockDhcpHandler(Handler, BaseMockHandler):
    ...
    def get_settings(self):
        ...
        """
        result = {
            "forwarding_enabled": MockDhcpHandler.forwarding_enabled,
            "dnssec_enabled": MockDhcpHandler.dnssec_enabled,
            "dns_from_dhcp_enabled": MockDhcpHandler.dns_from_dhcp_enabled,
        }
        if MockDhcpHandler.dns_from_dhcp_domain:
            result["dns_from_dhcp_domain"] = MockDhcpHandler.dns_from_dhcp_domain
        return result
    ...
    def update_settings(
        ...
        :rtype: bool
        """
        MockDhcpHandler.forwarding_enabled = forwarding_enabled
        MockDhcpHandler.dnssec_enabled = dnssec_enabled
        MockDhcpHandler.dns_from_dhcp_enabled = dns_from_dhcp_enabled
