...
class MockRedirectHandler(Handler, BaseMockHandler):
    ...
    def get_settings(self):
        ...
        """
        result = {
            "forwarding_enabled": MockRedirectHandler.forwarding_enabled,
            "dnssec_enabled": MockRedirectHandler.dnssec_enabled,
            "dns_from_dhcp_enabled": MockRedirectHandler.dns_from_dhcp_enabled,
        }
        if MockRedirectHandler.dns_from_dhcp_domain:
            result["dns_from_dhcp_domain"] = MockRedirectHandler.dns_from_dhcp_domain
        return result
    ...
    def update_settings(
        ...
        :rtype: bool
        """
        MockRedirectHandler.forwarding_enabled = forwarding_enabled
        MockRedirectHandler.dnssec_enabled = dnssec_enabled
        MockRedirectHandler.dns_from_dhcp_enabled = dns_from_dhcp_enabled
