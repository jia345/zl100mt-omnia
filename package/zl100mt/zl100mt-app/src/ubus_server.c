        ...
        struct blob_attr *msg)
{
    ...
    printf("... get_gnss_info \r\n");

    blob_buf_init(&b, 0);
    blobmsg_add_string(&b, "result", "ok");
    blobmsg_add_string(&b, "connection", "on");
    blobmsg_add_string(&b, "signal", "1.1");
    blobmsg_add_string(&b, "satelliteNum", "9");
    blobmsg_add_string(&b, "totalMsg", "344");
    blobmsg_add_string(&b, "succMsg", "244");
    blobmsg_add_string(&b, "failMsg", "100");
    blobmsg_add_string(&b, "targetSim", "430290");
    blobmsg_add_string(&b, "localSim", "333333");
...
static struct ubus_object_type zl100mt_object_type =
UBUS_OBJECT_TYPE("zl100mt", zl100mt_methods);
